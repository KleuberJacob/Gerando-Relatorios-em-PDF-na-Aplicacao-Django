...
class IndexView(View):
    ...
    def get(self, request, *args, **kwargs):
        # Cria um arquivo para receber os dados e gerar PDF
        buffer = io.BytesIO()
        ...
        # Abre o PDF direto no navegador caso o mesmo possua plugin
...
class Index2View(View):
    ...
    def get(self, request, *args, **kwargs):
        texto = ['Geek University', 'Evolua seu lado geek', 'Programaçao Web com Python e Django']
        ...
        with fs.open('relatorio2.pdf') as pdf:
            ...
            # Abre o PDF direto no navegador o mesmo deve possuir plugin
